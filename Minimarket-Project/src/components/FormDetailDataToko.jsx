      ...
      <div className="bg-white shadow-md rounded-lg p-8 w-full">
        <form className="space-y-4">
          ...
          <div className="flex justify-between space-x-4 mt-6">
            <button
              type="button"
              className="px-10 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none mt-7"
            >
              Hapus Toko
            </button>
...
export default FormDetailDataToko